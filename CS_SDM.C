...
TComplex SDM_N_R(double Eg, double costh) {
  TComplex I;
  TComplex N = TComplex(0,0);
  for (int mi=-1; mi<=+1; mi+=2) {
    for (int mf=-1; mf<=+1; mf+=2) {
...
TComplex rho0_R(double Eg, double costh, int lambda, int lambdap) {
  TComplex I1, I2;
  TComplex sum = TComplex(0,0);
  for (int mi=-1; mi<=+1; mi+=2) {
    for (int mf=-1; mf<=+1; mf+=2) {
...
TComplex rho1_R(double Eg, double costh, int lambda, int lambdap) {
  TComplex I1, I2;
  TComplex sum = TComplex(0,0);
  for (int mi=-1; mi<=+1; mi+=2) {
    for (int mf=-1; mf<=+1; mf+=2) {
...
TComplex rho2_R(double Eg, double costh, int lambda, int lambdap) {
  TComplex I1, I2;
  TComplex sum = TComplex(0,0);
  for (int mi=-1; mi<=+1; mi+=2) {
    for (int mf=-1; mf<=+1; mf+=2) {
  ...
  return (TComplex(0,1) * sum / SDM_N_R(Eg, costh));
}
