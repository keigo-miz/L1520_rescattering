...
/* scalar function */
TComplex M_P(double s, double t, double Cp = 0.6489) {
  double sp = 4.;  // [GeV^2]
...
TComplex Pomeron_amp(double Eg, double costh, int hel_gamma, int hel_phi, int mi, int mf, double Cp) {
  if (Eg<1.574) return TComplex(0,0);
